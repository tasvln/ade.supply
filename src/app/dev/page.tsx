...
//   }
  ...
  return (
    <div className="w-full h-dvh overflow-hidden flex items-center justify-center flex-col gap-1">
        <p className="">&quot;hold on... the portfolio&apos;s being updated&quot;</p>
        <a 
            href="https://docs.google.com/document/d/1LFcVW9fDvCp6KHHf5StxkjV87jo-bG2ASFDwAAWnnjQ/edit?usp=sharing" 
            className="text-sm mt-4 text-blue-600"
        >
            view Resume
        </a>
        <a 
            href="https://github.com/tasvln" 
