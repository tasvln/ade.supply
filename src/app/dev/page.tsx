const Dev = () => {
  return (
    <div className="flex flex-col mx-auto gap-2 max-w-3xl text-lg my-16 p-4">
      <p>Hi,</p>
      <p>I'm <b className="text-xl">Temitope Adebayo</b>, a Software Developer living in Toronto, Ontario</p>
      <p>
      ...
      <p>
        My personal projects can be found on my <i className="text-xl"><b><a className="link" href="">GitHub</a></b></i> and bigger personal projects through <i className="text-xl"><b><a href="" className="link">Nrma</a></b></i>
      </p>
      ...
      <ul className="capitalize list-disc">
        ...
        <li><a className="link" href="">assembly station (C++)</a></li>
